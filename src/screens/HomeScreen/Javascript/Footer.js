      ...
      <Container>
        <Row className="justify-content=evenly">
          ...
          <Col sm={6} md={3} className="col-me">
            ...
            <ul>
              <p><a href="https://www.iitr.ac.in/">IIT Roorkee</a></p>
              <p><a href="https://unnatbharatabhiyan.gov.in/">UBA IIT Delhi</a></p>
              <p><a href="/faculty">Faculty</a></p>
              <p><a href="/studentteam">Student Team</a></p>
          ...
          <Col sm={6} md={3} className="col-me">
            <h5 id="footer_title">UBA SOCIAL MEDIA
            </h5>
            <ul>
              <p>
